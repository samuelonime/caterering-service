      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="password" required value={password} onChange={e => setPassword(e.target.value)} className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none" placeholder="••••••" />
          </div>
        ...
        <div className="mt-6 p-3 bg-gray-50 rounded-lg text-xs text-gray-500">
          ...
          <p>Admin: admin@catering.com / admin123</p>
          <p>Client: Register a new account</p>
        </div>
      </div>
    </div>
  );
